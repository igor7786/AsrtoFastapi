from app_main.imports import (APIRouter, select, HTTPException, JSONResponse, jsonable_encoder, IntegrityError,
                              timedelta, bcrypt)
from app_main.models.models_schema_validation import User
from app_main.models.models import Users
from app_main.routes_blueprints.uttils.dependancies import (dependency_db, dependency_time_now,
                                                            dependency_form_data)
from app_main.global_helpers.app_logging import logger
from app_main.routes_blueprints.uttils.helpers_auth import (_auth_user, bcrypt_context, _create_jwt_token)

if not hasattr(bcrypt, '__about__'):
	bcrypt.__about__ = type('about', (object,), {'__version__': bcrypt.__version__})
# from app_main.models.models import Book
