...
from app_main.imports import (APIRouter, select, Query, Body, UUID, Response, HTTPException, JSONResponse,
                              jsonable_encoder, datetime)
from app_main.routes_blueprints.uttils.dependancies import current_user, dependency_db, dependency_time_now
from app_main.models.models import Book, Books, Users
from app_main.global_helpers.app_logging import logger
from app_main.routes_blueprints.uttils.helpers_book import _update_class_fields
