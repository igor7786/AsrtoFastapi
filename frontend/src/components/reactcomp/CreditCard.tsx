...
import { CreditCard, type CreditCardValue } from '@rcomp/ui/creditcard';
              ...
              <FormItem className="flex flex-col">
                ...
                <FormControl>
                  <CreditCard
                    ...
                    cvvLabel="CVC"
                    cardStyle="amex-green"
                    showVendor={true}
                    className="w-full"
                  />
                </FormControl>
                <FormDescription>
                  All fields are required. Your information is secure and encrypted.
                </FormDescription>
                <p className={`mt-1 min-h-[2rem] text-xs`}>
                  <FormMessage />
                </p>
              </FormItem>
            )}
