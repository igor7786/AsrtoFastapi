...
import { useIsMobile } from '@/components/reactcomp/hooks/use-mobile';
import { Badge } from '@/components/reactcomp/ui/badge';
...
import {
  ...
  ChartTooltip,
  ChartTooltipContent,
} from '@/components/reactcomp/ui/chart';
...
import {
  ...
  DrawerTitle,
  DrawerTrigger,
} from '@/components/reactcomp/ui/drawer';
import {
  DropdownMenu,
  ...
  DropdownMenuTrigger,
} from '@/components/reactcomp/ui/dropdown-menu';
...
import {
  ...
  SelectTrigger,
  SelectValue,
} from '@/components/reactcomp/ui/select';
...
import {
  ...
  TableHeader,
  TableRow,
} from '@/components/reactcomp/ui/table';
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@/components/reactcomp/ui/tabs';
  ...
  },
  {
    ...
    cell: ({ row }) => (
      ...
      >
        ...
        <Input
          className="h-8 w-16 border-transparent bg-transparent text-right shadow-none hover:bg-input/30
            focus-visible:border focus-visible:bg-background dark:bg-transparent dark:hover:bg-input/30
  ...
  return (
    <Tabs className="w-full flex-col justify-start gap-6" defaultValue="outline">
      <div className="flex items-center justify-between px-4 lg:px-6">
        ...
        <TabsList
          className="hidden **:data-[slot=badge]:size-5 **:data-[slot=badge]:rounded-full
            **:data-[slot=badge]:bg-muted-foreground/30 **:data-[slot=badge]:px-1 @4xl/main:flex"
        >
          <TabsTrigger value="outline">Outline</TabsTrigger>
          <TabsTrigger value="past-performance">
            Past Performance <Badge variant="default">3</Badge>
          </TabsTrigger>
          <TabsTrigger value="key-personnel">
            Key Personnel <Badge variant="default">2</Badge>
          </TabsTrigger>
