...
import {
  ...
  SheetHeader,
  SheetTitle,
} from '@/components/reactcomp/ui/sheet';
...
import {
  ...
  TooltipProvider,
  TooltipTrigger,
} from '@/components/reactcomp/ui/tooltip';
  ...
  return (
    <Comp
      className={cn(
        ...
        hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 [&>svg]:size-4
        [&>svg]:shrink-0`,
  ...
  return (
    <Comp
      className={cn(
        ...
        text-sidebar-foreground ring-sidebar-ring outline-hidden hover:bg-sidebar-accent
