...
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@rcomp/ui/select';
import { Card } from '@rcomp/ui/card';
    ...
    <div ref={containerRef} className={cn('w-full max-w-sm py-2', className)}>
        ...
        >
          ...
          >
            <div className="flex items-start justify-between">
              <div className={cn('h-8 w-12 rounded shadow-md', getChipColor())}></div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-end justify-between">
                <div className="flex-1">
                  <div className="text-xs font-medium uppercase opacity-70">Card Holder</div>
                  <div className="text-sm font-bold">{currentValue.cardholderName || 'YOUR NAME'}</div>
                </div>
                <div className="flex-1 text-center">
                  <div className="text-xs font-medium uppercase opacity-70">Expires</div>
                ...
                <div className="flex flex-1 justify-end">{showVendor && CardIcons[cardType]}</div>
              </div>
            </div>
          </Card>
          ...
          <Card
            className={cn(
              'absolute inset-0 flex h-full w-full [transform:rotateY(180deg)] flex-col justify-between p-6 shadow-xl [backface-visibility:hidden]',
          ...
          >
            ...
            <div className="flex items-center justify-end space-x-4">
              <div className="text-right">
                <div className="text-xs font-medium uppercase opacity-70">{cvvLabel}</div>
      ...
      <div className="space-y-4">
        <div>
          ...
          <Input
            ...
            className={cn(
              ...
              focusedField === 'cardholderName' && 'ring-primary ring-2',
              errors.cardholderName && 'border-destructive'
            )}
          />
          <p
            className={`mt-1 min-h-[1rem] text-xs ${
              errors.cardholderName ? 'text-destructive visible' : 'invisible'
            }`}
          >
            {errors.cardholderName || ''} {/* ← zero-width space to keep height */}
          </p>
        </div>
        ...
        <div>
          ...
          <Input
            ...
            className={cn(
              ...
              focusedField === 'cardNumber' && 'ring-primary ring-2',
          ...
          <p
            className={`mt-1 min-h-[1rem] text-xs ${
              errors.cardNumber ? 'text-destructive visible' : 'invisible'
            }`}
          >
            {errors.cardNumber || ''} {/* zero-width space to preserve height */}
          </p>
        </div>
        ...
        <div className="grid grid-cols-3 gap-4">
          <div>
            ...
            >
              <SelectTrigger
                className={cn(
                  'transition-all duration-200',
                  focusedField === 'expiryMonth' && 'ring-primary ring-2',
            ...
            <p
              className={`mt-1 min-h-[2rem] text-xs ${
                errors.expiryMonth ? 'text-destructive visible' : 'invisible'
              }`}
            >
              {errors.expiryMonth || ''}
            </p>
          ...
          <div>
            ...
            >
              <SelectTrigger
                className={cn(
                  'transition-all duration-200',
                  focusedField === 'expiryYear' && 'ring-primary ring-2',
            ...
            <p
              className={`mt-1 min-h-[2rem] text-xs ${
                errors.expiryYear ? 'text-destructive visible' : 'invisible'
              }`}
            >
              {errors.expiryYear || ''}
            </p>
          ...
          <div>
            <label className="mb-2 block text-sm font-medium">{cvvLabel}</label>
            <Input
              ref={cvvInputRef}
              type="text"
              placeholder="123"
              ...
              className={cn(
                ...
                focusedField === 'cvv' && 'ring-primary ring-2',
            ...
            <p
              className={`mt-1 min-h-[2rem] text-xs ${
                errors.cvv ? 'text-destructive visible' : 'invisible'
              }`}
            >
              {errors.cvv || ''}
            </p>
