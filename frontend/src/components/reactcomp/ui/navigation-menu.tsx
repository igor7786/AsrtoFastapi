...
function NavigationMenuContent({
  ...
  return (
    <NavigationMenuPrimitive.Content
      className={cn(
        `top-0 left-0 w-full p-2 pr-2.5 data-[motion=from-end]:slide-in-from-right-52
    ...
    <div className={cn('absolute top-full left-0 isolate z-50 flex justify-center')}>
      <NavigationMenuPrimitive.Viewport
        className={cn(
          ...
          data-[state=closed]:animate-out data-[state=closed]:zoom-out-95 data-[state=open]:animate-in
...
function NavigationMenuLink({
  ...
  return (
    <NavigationMenuPrimitive.Link
      className={cn(
        `flex flex-col gap-1 rounded-sm p-2 text-sm transition-all outline-none hover:bg-accent
