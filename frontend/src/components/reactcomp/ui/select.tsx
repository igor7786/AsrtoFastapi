...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      className={cn(
        `flex w-fit items-center justify-between gap-2 rounded-md border border-input bg-transparent px-3
        py-2 text-sm whitespace-nowrap shadow-xs transition-[color,box-shadow] outline-none
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        className={cn(
          ...
          border bg-popover text-popover-foreground shadow-md data-[side=bottom]:slide-in-from-top-2
  ...
  return (
    <SelectPrimitive.Item
      className={cn(
        ...
        [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4
        [&_svg:not([class*='text-'])]:text-muted-foreground *:[span]:last:flex *:[span]:last:items-center
        *:[span]:last:gap-2`,
        className
      )}
