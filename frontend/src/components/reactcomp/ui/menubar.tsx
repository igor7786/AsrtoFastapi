  ...
  return (
    <MenubarPrimitive.Item
      className={cn(
        ...
        dark:data-[variant=destructive]:focus:bg-destructive/20 [&_svg]:pointer-events-none
  ...
  return (
    <MenubarPrimitive.SubTrigger
      className={cn(
        ...
        focus:bg-accent focus:text-accent-foreground data-[inset]:pl-8 data-[state=open]:bg-accent
        data-[state=open]:text-accent-foreground`,
        className
      )}
      data-inset={inset}
...
function MenubarSubContent({
  ...
  return (
    <MenubarPrimitive.SubContent
      className={cn(
        `z-50 min-w-[8rem] origin-(--radix-menubar-content-transform-origin) overflow-hidden rounded-md
        border bg-popover p-1 text-popover-foreground shadow-lg data-[side=bottom]:slide-in-from-top-2
