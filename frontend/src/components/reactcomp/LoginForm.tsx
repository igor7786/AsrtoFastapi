...
import {
	type LoginSchema,
	loginSchema,
} from "@/lib/types-schemas-validator/login-schema";
...
export function LoginForm({
	...
	const [state, action, pending] = useActionState(
		withState(actions.submitPerson),
		{
					...
					<div className={cn("flex flex-col gap-6", className)} {...props}>
						<Card className="relative overflow-hidden">
							...
							<CardContent>
								...
								<div
									className="relative py-4 text-center text-sm text-muted-foreground after:absolute
                    after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-t
                    after:border-primary dark:after:border-yellow-200"
								>
										...
										<FormField
											...
											render={({ field }) => (
												<FormItem>
													...
													<FormControl>
														<Input
															className={`border-[1px] text-foreground autofill:text-input
                              focus-visible:border-green-500/50 focus-visible:ring-0`}
                              ...
                              focus-visible:border-green-500/50 focus-visible:ring-0`}
										...
										>
											{pending ? (
												<div className="flex items-center justify-center gap-4 disabled:text-primary">
													<span>Loading</span>
						...
						<div
							className="text-center text-xs text-balance text-muted-foreground *:[a]:underline
