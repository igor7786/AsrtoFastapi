...
export default function LoginForm1() {
  ...
  const strength = requirements.map((r) => ({
    ...r,
      ...
      <div className="w-full space-y-12 sm:max-w-md">
        <div className="text-center">
          ...
          <div className="mt-5 space-y-2">
            ...
            <p>
              ...
              <a className="font-medium text-rose-600 hover:text-rose-500" href="#">
                Sign up
              </a>
            </p>
          </div>
        ...
        <div className="space-y-8 p-4 py-6 shadow sm:rounded-lg sm:p-6">
          ...
          <div className="relative py-6">
            <span className="block h-px w-full bg-amber-200" />
            ...
            <div className="relative">
              ...
              <div className="relative">
                <input
                  ...
                  value={email}
                />
                <span className="absolute inset-y-0 right-0 mt-2 mr-3 flex items-center">
            ...
            <div className="relative">
              ...
              {password.length > 0 && (
                <div className="mt-3">
                  ...
                  {/* Only show requirements if not fully met */}
                  {strengthScore < 4 && (
                    <>
                      <p className="mb-1 text-sm font-medium">{getStrengthText()}. Must contain:</p>
